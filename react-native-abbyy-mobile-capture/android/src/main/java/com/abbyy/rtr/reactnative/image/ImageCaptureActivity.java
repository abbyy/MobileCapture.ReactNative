...
import com.abbyy.rtr.reactnative.R;
import com.abbyy.rtr.reactnative.SharedEngine;
import com.abbyy.rtr.reactnative.utils.BackgroundWorker;
...
public class ImageCaptureActivity extends AppCompatActivity implements MultiPageImageCaptureScenario.Callback {
	...
	protected void onCreate( @Nullable Bundle savedInstanceState )
	{
		...
		setContentView( R.layout.uic_activity_image_capture );
	...
	private void showDiscardPagesDialog( final Result result )
	{
		AlertDialog.Builder builder = new AlertDialog.Builder( this )
			.setTitle( R.string.uic_rn_ic_delete_on_cancel_warning_title )
			.setMessage( R.string.uic_rn_ic_delete_on_cancel_warning_message )
			.setPositiveButton( R.string.uic_rn_ic_delete_on_cancel_warning_positive_button, new DialogInterface.OnClickListener() {
				@Override
			...
			.setNegativeButton( R.string.uic_rn_ic_delete_on_cancel_warning_negative_button, null )
	...
	private void showPagesProcessingDialog()
	{
		...
		View dialogView = getLayoutInflater().inflate( R.layout.uic_dialog_progress, null );

		pagesProcessingDialog = new AlertDialog
			.Builder( this )
			.setCancelable( false )
			.setTitle( R.string.uic_rn_ic_saving_pages_warning_message )
			.setView( dialogView )
			.create();
